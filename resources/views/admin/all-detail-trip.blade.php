          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <table id="example2" class="table table-bordered">
                  ...
                  <a href="/admin/edit-detail-trip/{{$pack->book_id}}" class="btn btn-primary">Update Trip Status</a>
                  <br>
                  <a href="/admin/all-trip" class="btn btn-primary">Back to List of Running & Closed Trip</a>
