          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <table id="example2" class="table table-bordered">
                  ...
                  <a href="/admin/edit-detail-booking/{{$pack->book_id}}" class="btn btn-primary">Update Trip Status</a>
                  <br>
                  <a href="/admin/view-booking" class="btn btn-primary">Back to List of Bookings</a>
