...
<script type="text/javascript" src="{{asset('admin/dist/js/bootstrap.bundle.min.js')}}"></script>
<script type="text/javascript" src="{{asset('admin/dist/js/bootstrap.min.js')}}"></script>
<script type="text/javascript">
  
  $(document).ready(function(){

      $(".add_from_place_button").click(function(){
        $("#exampleModal_place").modal('show');
      });

      $('#submit_add_place').click(function(){

          var place = $('#place_add').val();
          
          $("#exampleModal_place").modal('hide');
          ...
          $.ajax({
              ...
              {
                  $('.add_input_of_place').append("<div class='from_place_fles'><input type='checkbox' name='from[]' value='"+place+"' checked>"+place+"</input> <input type='number' class='form-control amt_add' id='"+place+"' placeholder='Enter price from "+place+"' name='price[]' maxlength='100' required>");
              }
          });
      });
      ...
      $('#add_day').click(function(){
          ...
          $.ajax({
              ...
              success:function(res)
              {
                  $('#day_added').append('<label for="exampleInputPassword1">Day '+id+':</label><textarea rows="3" class="form-control" id="exampleInputPassword1" placeholder="Enter details" name="day[]" maxlength="1000" required></textarea>');
                  $('#increment').val(new_id);
              }
          });
      });
