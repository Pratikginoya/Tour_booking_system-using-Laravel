                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 mb60">
                        <div class="awards-block">
                            <div class="awards-img"><img src="{{asset('imagess/certificate_1.png')}}" alt=""></div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 mb60">
                        <div class="awards-block">
                            <div class="awards-img"><img src="{{asset('imagess/certificate_2.png')}}" alt=""></div>
                            <div class="awards-content">
                                <h4 class="awards-title">Authorized By Tourist Board</h4>
                            </div>
                        </div>
                    </div>
                    <!-- /.awards -->
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 mb60">
                        <div class="awards-block">
                            <div class="awards-img"><img src="{{asset('imagess/certificate_3.png')}}" alt=""></div>
                            <div class="awards-content">
